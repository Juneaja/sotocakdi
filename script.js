...
if (bookingForm) {
  bookingForm.addEventListener('submit', (e) => {
    ...
    const message = `*Assallamuallaikum, Soto Ayam Cak Di, saya ingin pesan soto ayam:*%0A%0A*Nama:* ${data.name}%0A*Alamat Lengkap:* ${data.destination}%0A*Jumlah Pesanan:* ${data.destination}%0A*Pilihan Menu:* ${data.carType}%0A%0ATerima kasih!`;
